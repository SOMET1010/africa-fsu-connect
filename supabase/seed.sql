...
INSERT INTO public.navigation_items (href, location, label, sort_order, user_role, reference, parent, is_visible, is_external) VALUES
  ('/projects', 'header', '{"ar": "مشاريع الخدمة الشاملة", "en": "FSU Projects", "fr": "Projets", "pt": "Projetos FSU"}', '1', ARRAY['public','reader'], 'projects', null, 'true', 'false'), 
  ('/about', 'header', '{"ar": "عن", "en": "About", "fr": "A Propos", "pt": "Sobre"}', '0', ARRAY['public','reader'], 'about', 'home', 'true', 'false'), 
  ('/watch', 'header', '{"ar": "أخبار", "en": "News", "fr": "Actualités", "pt": "Notícias"}', '0', ARRAY['public','reader'], 'news-watch', 'watch', 'true', 'false'), 
  ('/my-contributions', 'header', '{"ar": "مشاريعي", "en": "My Projects", "fr": "Mes Projets", "pt": "Os meus projetos"}', '2', ARRAY['public','reader'], 'my-contributions', 'projects', 'true', 'false'), 
  ('/resources', 'header', '{"ar": "الموارد", "en": "Resources", "fr": "Ressources", "pt": "Recursos"}', '2', ARRAY['public','reader'], 'resources', null, 'true', 'false'), 
  ('/events?cmdt25=true', 'header', '{"ar": "CMDT-25", "en": "CMDT-25", "fr": "CMDT-25", "pt": "CMDT-25"}', '1', ARRAY['public','reader'], 'events?cmdt25=true', 'events', 'true', 'false'), 
  ('/watch', 'header', '{"ar": "تغذية آر إس إس", "en": "RSS feed", "fr": "Flux RSS", "pt": "Feed RSS"}', '1', ARRAY['public','reader'], 'rss-watch', 'watch', 'true', 'false'), 
  ('/events-calendar', 'header', '{"ar": "تقويم", "en": "Calendar", "fr": "Calendrier", "pt": "Calendário"}', '0', ARRAY['public','reader'], 'events-calendar', 'events', 'true', 'false'), 
  ('/agency-documents', 'header', '{"ar": "القوالب والنماذج", "en": "Templates & Forms", "fr": "Modèles & Formulaires", "pt": "Modelos e formulários"}', '2', ARRAY['public','reader'], 'agency-documents', 'resources', 'true', 'false'), 
  ('/members', 'header', '{"ar": "دليل", "en": "Members", "fr": "Annuaire", "pt": "Diretório"}', '1', ARRAY['public','reader'], 'directory', 'forum', 'true', 'false'), 
  ('/watch', 'header', '{"ar": "المراقبة", "en": "Watch", "fr": "Veille", "pt": "Vigilância"}', '6', ARRAY['public','reader'], 'watch', null, 'true', 'false'), 
  ('/', 'header', '{"ar": "الرئيسية", "en": "Home", "fr": "Accueil", "pt": "Início"}', '0', ARRAY['public','reader'], 'home', null, 'true', 'false'), 
  ('/strategies', 'header', '{"ar": "السياسات والأطر", "en": "Policies & Frameworks", "fr": "Politiques & Cadres", "pt": "Políticas e Estruturas"}', '1', ARRAY['public','reader'], 'strategies', 'resources', 'true', 'false'), 
  ('/resources', 'header', '{"ar": "مكتبة", "en": "Library", "fr": "Bibliothèque", "pt": "Biblioteca"}', '0', ARRAY['public','reader'], 'library', 'resources', 'true', 'false'), 
  ('/public-dashboard', 'header', '{"ar": "لوحة القيادة", "en": "Dashboard", "fr": "Tableau de Bord", "pt": "Painel"}', '7', ARRAY['public','reader'], 'public-dashboard', null, 'false', 'false'), 
  ('/', 'header', '{"ar": "الرئيسية", "en": "Home", "fr": "Accueil", "pt": "Início"}', '0', ARRAY['public','reader'], 'public-home', 'home', 'true', 'false'), 
  ('/events', 'header', '{"ar": "الجدول الزمني", "en": "Agenda", "fr": "Agenda", "pt": "Agenda"}', '5', ARRAY['public','reader'], 'events', null, 'true', 'false'), 
  ('/registrations-elearning', 'header', '{"ar": "تسجيلاتي", "en": "My Registrations", "fr": "Mes Inscriptions", "pt": "Minhas Inscrições"}', '2', ARRAY['public','reader'], 'registrations-elearning', 'elearning', 'true', 'false'), 
  ('/coauthoring', 'header', '{"ar": "التأليف المشترك", "en": "Co-authoring", "fr": "Co-rédaction", "pt": "Coautoria"}', '2', ARRAY['public','reader'], 'coauthoring', 'forum', 'true', 'false'), 
  ('/map', 'header', '{"ar": "الخريطة التفاعلية", "en": "Interactive Map", "fr": "Carte Interactive", "pt": "Mapa interativo"}', '0', ARRAY['public','reader'], 'map', 'projects', 'true', 'false'), 
  ('/catalog', 'header', '{"ar": "كتالوج", "en": "Catalog", "fr": "Catalogue", "pt": "Catálogo"}', '0', ARRAY['public','reader'], 'catalog', 'elearning', 'true', 'false'), 
  ('/elearning', 'header', '{"ar": "التعلم الإلكتروني", "en": "E-Learning", "fr": "E-Learning", "pt": "E-Learning"}', '1', ARRAY['public','reader'], 'elearning-view', 'elearning', 'true', 'false'), 
  ('/projects', 'header', '{"ar": "قائمة المشاريع", "en": "FSU Projects", "fr": "Liste des Projets", "pt": "Projetos FSU"}', '1', ARRAY['public','reader'], 'project-view', 'projects', 'true', 'false'), 
  ('/forum', 'header', '{"ar": "منتدى المناقشة", "en": "Discussion Forum", "fr": "Forum de Discussion", "pt": "Fórum de discussão"}', '0', ARRAY['public','reader'], 'forum-view', 'forum', 'true', 'false'), 
  ('/elearning', 'header', '{"ar": "التدريب", "en": "Training", "fr": "Formation", "pt": "Formação"}', '4', ARRAY['public','reader'], 'elearning', null, 'true', 'false'), 
  ('/forum', 'header', '{"ar": "المجتمع", "en": "Community", "fr": "Communauté", "pt": "Comunidade"}', '3', ARRAY['public','reader'], 'forum', null, 'true', 'false');
