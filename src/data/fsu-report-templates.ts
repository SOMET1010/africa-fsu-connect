...
export const reportTemplates: ReportTemplate[] = [
  {
    ...
    description: 'Rapport annuel complet du Fonds du Service Universel conforme aux recommandations GSMA',
    category: 'annual',
    exportFormats: ['pdf', 'docx', 'md'],
    sections: [
      {
        ...
        description: 'Synthèse des principaux accomplissements et défis de l\'année',
        placeholder: 'Présentez les faits saillants de l\'année : budget total, projets réalisés, population couverte, défis majeurs...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        description: 'État des fonds collectés, décaissés et disponibles',
        placeholder: 'Détaillez les flux financiers : contributions des opérateurs, décaissements par projet, solde disponible...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        description: 'Liste et résultats des projets achevés durant l\'année',
        placeholder: 'Pour chaque projet : nom, localisation, budget, population bénéficiaire, résultats atteints...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Pour chaque projet en cours : état d\'avancement, budget consommé, difficultés rencontrées, prochaines étapes...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Présentez les KPIs : population nouvellement couverte, écart de connectivité réduit, coût par bénéficiaire...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Décrivez les obstacles majeurs et comment ils ont été surmontés ou ce qui sera fait différemment...',
        required: false,
        tips: [
      ...
      },
      {
        id: 'outlook',
        title: 'Perspectives',
        description: 'Orientations et projets prévus pour l\'année suivante',
        placeholder: 'Présentez la stratégie, les projets planifiés, le budget prévisionnel, les objectifs...',
        required: true,
        tips: [
    ...
    sections: [
      {
        ...
        placeholder: 'Nom du projet, code, localisation, date de démarrage, budget total, partenaires...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Pourcentage d\'avancement global, conformité au calendrier, état du budget...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Listez les activités réalisées : installations, tests, formations...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Budget engagé, dépensé, reste à consommer, écarts...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Décrivez les problèmes rencontrés et les mesures prises ou à prendre...',
        required: false,
        tips: [
          'Proposer des solutions',
      ...
      },
      {
        ...
        placeholder: 'Listez les activités planifiées avec dates et responsables...',
        required: true,
        tips: [
          'Être réaliste',
    ...
    sections: [
      {
        ...
        placeholder: 'Décrivez le sujet de la consultation, sa période, les parties invitées...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Opérateurs, associations, communautés, experts... ayant contribué',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Résumez les principales contributions, suggestions et préoccupations exprimées...',
        required: true,
        tips: [
          'Regrouper par thème',
          'Rester objectif',
      ...
      },
      {
        ...
        placeholder: 'Analysez les retours et présentez les recommandations qui en découlent...',
        required: true,
        tips: [
          'Justifier les choix',
      ...
      },
      {
        ...
        description: 'Résumé des décisions résultant de la consultation',
        placeholder: 'Listez les décisions prises suite à cette consultation...',
        required: true,
        tips: [
    ...
    sections: [
      {
        ...
        placeholder: 'Population couverte (2G/3G/4G/5G), zones desservies, écart de couverture...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Taux de pénétration, abonnés actifs, écart d\'utilisation...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        placeholder: 'Taux de décaissement, coût par bénéficiaire, ROI estimé...',
        required: true,
        tips: [
      ...
      },
      {
        ...
        description: 'Métriques relatives aux projets FSU',
        placeholder: 'Projets complétés, en cours, en retard, taux de réussite...',
        required: true,
        tips: [
...
export const getTemplatesByCategory = (category: ReportTemplate['category']): ReportTemplate[] => {
