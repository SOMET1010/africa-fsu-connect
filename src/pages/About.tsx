    ...
    <div className="space-y-12 relative z-10">
      ...
      <div className="space-y-6 container mx-auto px-0 py-8">
        ...
        <div className="grid md:grid-cols-5 gap-4">
          ...
          {/* Governance */}
      <section className="bg-white py-10">
          <div className="grid lg:grid-cols-2 gap-8 container mx-auto px-0 py-8">
        ...
        <section className="bg-white py-10">
          ...
          {/* Contact */}
      <section className="bg-white py-10">
              <Card className="bg-card/50 backdrop-blur-md border-border container mx-auto px-8 py-4">
