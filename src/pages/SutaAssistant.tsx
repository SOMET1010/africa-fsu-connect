    ...
    const quickActions = [
        {
            ...
            icon: FileText,
            query: "Quels sont les Projets actifs en Afrique de l'Ouest ?",
        },
        {
            label: "Statistiques",
            icon: BarChart3,
            query: "Montre-moi les statistiques de couverture par région",
        },
        {
            label: "Réglementation",
            icon: Globe,
            query: "Quelles sont les principales réglementations FSU ?",
        },
        {
            label: "Aide",
            icon: HelpCircle,
            query: "Comment utiliser la plateforme UDC ?",
        },
    ]
        ...
        <div className="min-h-screen bg-[hsl(var(--nx-bg))]">
            <div className="container mx-auto px-4 py-8 max-w-4xl space-y-6">
                ...
                <PageHero
                    ...
                    subtitle="Posez vos questions sur le Service Universel, les Projets et la plateforme UDC"
                />
                ...
                <div className="text-center text-xs text-white/50 animate-fade-in">
                    <p>
                        SUTA utilise l'IA pour vous aider. Les réponses peuvent
                        parfois être imprécises.
                        <ModernButton
                            variant="link"
                            size="sm"
                            className="text-xs px-1 text-white/50 hover:text-white/70"
                        >
                            En savoir plus
                        </ModernButton>
                    </p>
