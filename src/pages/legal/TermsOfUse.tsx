    ...
    <main className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-8 text-white/80">
        <section>
          ...
          <p>Les présentes conditions d'utilisation régissent l'accès et l'utilisation de la plateforme NEXUS, un réseau numérique panafricain dédié à la coordination des Fonds de Service Universel (FSU) des télécommunications, opéré sous l'égide de l'Union Africaine des Télécommunications (UAT).</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-white">2. Accès à la plateforme</h2>
          <p>L'accès à la plateforme est réservé aux représentants des organismes membres du réseau SUTEL, aux partenaires institutionnels et aux personnes dûment autorisées. L'inscription requiert la fourniture d'informations exactes et vérifiables.</p>
        </section>
