        ...
        <div className="min-h-screen bg-[hsl(var(--nx-bg))]">
            <div className="container mx-auto px-4 py-8 space-y-8">
                <PageHero
                    ...
                    subtitle="Calculez les coûts complets de vos Projets (CAPEX et OPEX) selon les recommandations GSMA"
                />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <GlassCard className="p-6">
                            <Tabs defaultValue="capex" className="w-full">
                                <TabsList className="grid w-full grid-cols-2 bg-white/5">
                                    <TabsTrigger
                                        value="capex"
                                        className="data-[state=active]:bg-[hsl(var(--nx-gold))] data-[state=active]:text-black"
                                    >
                                        CAPEX (Investissement)
                                    </TabsTrigger>
                                    <TabsTrigger
                                        value="opex"
                                        className="data-[state=active]:bg-[hsl(var(--nx-cyan))] data-[state=active]:text-black"
                                    >
                                        OPEX (Opérationnel)
                                    </TabsTrigger>
                                </TabsList>
                                    ...
                                    <div className="space-y-2 max-h-64 overflow-y-auto">
                                        {projectData.capexItems.length === 0 ? (
                                            <p className="text-white/50 text-center py-8">
                                                Aucun élément CAPEX. Ajoutez des
                                                équipements, installations, etc.
                                            </p>
                                        ) : (
                                            projectData.capexItems.map(item => (
                                                ...
                                                >
                                                    <div className="flex-1">
                                                        <span className="text-[hsl(var(--nx-gold))] text-sm">
                                                            {item.category}
                                                        </span>
                                ...
                                >
                                    ...
                                    <div className="space-y-2 max-h-64 overflow-y-auto">
                                        {projectData.opexItems.length === 0 ? (
                                            <p className="text-white/50 text-center py-8">
                                                Aucun élément OPEX. Ajoutez les
                                                coûts d'énergie, maintenance,
                                                etc.
                                            </p>
                                        ) : (
                                            projectData.opexItems.map(item => (
                                                ...
                                                >
                                                    <div className="flex-1">
                                                        <span className="text-[hsl(var(--nx-cyan))] text-sm">
                                                            {item.category}
                                                        </span>
                                                        <p className="text-white text-sm">
                                                            {item.description ||
                        ...
                        {/* Graphiques */}
                        {(costResult.totalCAPEX > 0 ||
                            costResult.totalOPEXAnnual > 0) && (
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <GlassCard className="p-6">
                                    ...
                                    >
                                        <BarChart
                                            data={costResult.yearlyBreakdown}
                                        >
                                            <CartesianGrid
                                                strokeDasharray="3 3"
                    ...
                    <div className="space-y-6">
                        ...
                        <GlassCard className="p-6">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-[hsl(var(--nx-gold)/0.1)] rounded-lg border border-[hsl(var(--nx-gold)/0.2)]">
                                    <p className="text-[hsl(var(--nx-gold))] text-sm">
                                        Total CAPEX
                                    </p>
                                    <p className="text-2xl font-bold text-white">
                                        {formatCurrency(costResult.totalCAPEX)}
                                    </p>
                                </div>

                                <div className="p-4 bg-[hsl(var(--nx-cyan)/0.1)] rounded-lg border border-[hsl(var(--nx-cyan)/0.2)]">
                                    <p className="text-[hsl(var(--nx-cyan))] text-sm">
                                        OPEX annuel
                                    </p>
                                    <p className="text-2xl font-bold text-white">
                                        {formatCurrency(
                                            costResult.totalOPEXAnnual
                                        )}
                                    </p>
                                    <p className="text-white/50 text-sm mt-1">
                                        {formatCurrency(
                                            costResult.totalOPEXLifetime
                                        )}{" "}
                                        sur {projectData.projectDuration} ans
                                    </p>
                                </div>
                                ...
                                <div className="p-4 bg-[hsl(var(--primary)/0.1)] rounded-lg border border-[hsl(var(--primary)/0.2)]">
                                    <p className="text-[hsl(var(--primary-light))] text-sm font-medium">
                                        COÛT TOTAL DU PROJET
                                    </p>
                                    <p className="text-3xl font-bold text-white">
                                        {formatCurrency(
                                            costResult.totalProjectCost
                                        )}
                                    </p>
                                </div>
                        ...
                        {costResult.categoryBreakdown.length > 0 && (
                            <GlassCard className="p-6">
                                ...
                                <ResponsiveContainer width="100%" height={200}>
                                    <PieChart>
                                        <Pie
                                            data={costResult.categoryBreakdown.slice(
                                                0,
                                                7
                                            )}
                                            cx="50%"
                        ...
                        <GlassCard className="p-6">
                            <h3 className="text-[hsl(var(--nx-gold))] font-semibold mb-3">
                                💡 Recommandations GSMA
                            </h3>
                            <ul className="space-y-2 text-sm text-white/70">
                                <li>
                                    • Prévoir une durée de vie de 8 ans minimum
                                </li>
                                <li>
                                    • Inclure tous les coûts d'énergie et
                                    sécurité
                                </li>
                                <li>• Appliquer 10-15% de contingence</li>
                                <li>
                                    • Calculer le coût par bénéficiaire pour
                                    comparer
                                </li>
                            </ul>
                        </GlassCard>
