...
import { Calculator, ClipboardCheck, Percent, FileText, Wrench, ArrowRight } from 'lucide-react';
...
const tools: ToolCard[] = [
  {
    ...
    description: 'Calculez les coûts complets de vos projets FSU (CAPEX et OPEX) selon la méthodologie GSMA',
    icon: Calculator,
  ...
  },
  {
    ...
    description: 'Évaluez la maturité de votre FSU selon les 11 recommandations GSMA/UAT',
    icon: ClipboardCheck,
  ...
  },
  {
    ...
    description: 'Estimez le taux de contribution optimal pour atteindre vos objectifs de couverture',
    icon: Percent,
  ...
  },
  {
    ...
    description: 'Créez des rapports FSU structurés selon les standards GSMA',
    icon: FileText,
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--nx-bg))]">
      <div className="container mx-auto px-4 py-8 space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/70">
                Ces outils ont été conçus à partir du rapport GSMA/UAT "Les Fonds du Service Universel en Afrique" 
                pour vous aider à appliquer les meilleures pratiques dans la gestion de votre FSU. 
                Chaque outil utilise <strong className="text-white">vos propres données</strong> — aucune donnée 
                n'est partagée ou comparée avec d'autres pays.
              </p>
            </div>
          </div>
        </GlassCard>
          ...
          {tools.map((tool) => (
            ...
            >
              ...
              {tool.status === 'available' ? (
                ...
                <ModernButton disabled className="w-full opacity-50">
                  Bientôt disponible
                </ModernButton>
              )}
            </GlassCard>
        ...
        {/* Méthodologie */}
        <GlassCard className="p-6">
          <h2 className="text-lg font-semibold text-white mb-4">📚 Base Méthodologique</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-white/5 rounded-lg">
              <h3 className="text-[hsl(var(--nx-gold))] font-medium mb-2">Rapport GSMA/UAT</h3>
              <p className="text-white/60 text-sm">
                "Les Fonds du Service Universel en Afrique" — 11 recommandations pour des FSU efficaces
              </p>
            </div>
            <div className="p-4 bg-white/5 rounded-lg">
              <h3 className="text-[hsl(var(--nx-cyan))] font-medium mb-2">Données Souveraines</h3>
              <p className="text-white/60 text-sm">
                Vos données restent privées et ne sont jamais partagées avec d'autres pays
              </p>
            </div>
            <div className="p-4 bg-white/5 rounded-lg">
              <h3 className="text-[hsl(var(--primary))] font-medium mb-2">Bonnes Pratiques</h3>
              <p className="text-white/60 text-sm">
                Inspirées des succès du Maroc (Pay or Play), Ghana (GIFEC), et autres
              </p>
            </div>
          </div>
        </GlassCard>
