...
const AdminDashboard = () => {
    const [period, setPeriod] = useState<"24h" | "7d" | "30d" | "90d" | "1y">(
        "30d"
    )
    ...
    const { data: stats } = useQuery({
        ...
        queryFn: async () => {
            const [countries, projects, agencies, documents] =
                await Promise.all([
                    supabase
                        .from("countries")
                        ...
                        <div className="flex items-center gap-1 bg-muted rounded-lg p-1">
                            {periodOptions.map(option => (
                                <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                        setPeriod(option.value as typeof period)
                                    }
                                >
                                    {option.label}
                                </Button>
                ...
                <Tabs defaultValue="overview" className="space-y-6">
                    ...
                    <TabsContent value="overview" className="space-y-6">
                        ...
                        <GlassCard className="p-6">
                            ...
                            <p className="text-muted-foreground">
                                Les graphiques de tendances et analyses avancées
                                seront affichés ici.
                            </p>
                        </GlassCard>
                    </TabsContent>
                    ...
                    <TabsContent value="activity" className="space-y-6">
                        <GlassCard className="p-6">
                            ...
                            <p className="text-muted-foreground">
                                L'historique complet des activités et
                                modifications sera affiché ici.
                            </p>
                        </GlassCard>
                    </TabsContent>
                    ...
                    <TabsContent value="reports" className="space-y-6">
                        <GlassCard className="p-6">
                            ...
                            <p className="text-muted-foreground">
                                Les rapports de pilotage et exports seront
                                disponibles ici.
                            </p>
                        </GlassCard>
                    </TabsContent>
