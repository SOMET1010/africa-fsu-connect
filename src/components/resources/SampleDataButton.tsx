    ...
    const sampleDocuments = [
        {
            ...
            description:
                "Un guide complet sur les meilleures pratiques pour le développement rural dans la région ouest-africaine, incluant des stratégies d'agriculture durable et de gestion des ressources naturelles.",
        ...
        {
            title: "Rapport d'Impact - Projets 2023",
            description:
                "Analyse détaillée de l'impact des Projets menés en 2023 à travers différents pays africains, avec des données sur l'efficacité et les résultats obtenus.",
        ...
        },
        {
            ...
            description:
                "Présentation sur les nouvelles technologies appliquées à l'agriculture africaine, incluant l'IoT, les drones et les systèmes d'irrigation intelligents.",
        ...
        },
        {
            ...
            description:
                "Formulaire standardisé pour les candidatures aux programmes de formation FSU destinés aux professionnels du développement en Afrique.",
        ...
        },
        {
            ...
            description:
                "Analyse approfondie des programmes de microfinance mis en place dans plusieurs pays africains et leur impact sur l'inclusion financière des populations rurales.",
            document_type: "report" as const,
            country: "Tanzanie",
            mime_type: "application/pdf",
        ...
        },
        {
            ...
            description:
                "Manuel pratique pour la gestion durable des ressources en eau dans les communautés rurales africaines, avec des exemples concrets et des outils pratiques.",
            document_type: "guide" as const,
            country: "Ouganda",
            mime_type: "application/pdf",
    ...
    const addSampleData = async () => {
        if (!user) {
            toast({
                title: "Erreur",
                description:
                    "Vous devez être connecté pour ajouter des données",
                variant: "destructive",
            })
            return
        }
