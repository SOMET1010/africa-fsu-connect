...
const OFFICIAL_MESSAGES = [
  ...
  },
  {
    ...
    text: "L'ANSUT s'engage aux côtés de l'UAT pour faire de NEXUS un outil stratégique au service du déploiement du service universel. Cette plateforme renforce notre capacité collective à réduire la fracture numérique et à connecter les communautés les plus isolées.",
    initials: "DG",
  },
];
