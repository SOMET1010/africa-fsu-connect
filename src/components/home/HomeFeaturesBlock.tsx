...
const FALLBACK_FEATURES = [
    {
        icon: "Users",
        title: "55 Pays Membres",
        description: "Réseau panafricain des agences de régulation",
    },
    {
        icon: "Network",
        title: "Projets",
    ...
    },
    {
        icon: "FileText",
        title: "Ressources",
        description: "Documentation et guides méthodologiques",
    },
]
        ...
        <ScrollReveal delay={index * 150} direction="up">
            <div
                className={cn(
                    ...
                    d
                        ? "bg-white/5 border border-white/10 hover:border-[hsl(var(--nx-gold))]/40 hover:shadow-sm"
                        : "bg-[hsl(var(--nx-surface))] border border-[hsl(var(--nx-border))] shadow-[var(--nx-shadow-sm)] hover:border-[hsl(var(--nx-gold))]/40 hover:shadow-sm",
                    isRTL && "text-right"
                )}
            >
                <div
            ...
            <div className="container mx-auto px-4 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[1, 2, 3].map(i => (
                        <Skeleton
                            key={i}
                            className="h-36 bg-[hsl(var(--nx-border))] rounded-xl"
                        />
                    ))}
                </div>
            </div>
