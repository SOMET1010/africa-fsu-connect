...
export function HomeHeroBlock() {
  ...
  */
  ...
  const heroKpis = [
    {
      icon: Users,
      label: t("label.heroKpis.countries"),
      value: countriesCount || 0,
      delta: statsLoading ? t("label.heroKpis.statsLoading.loading") : t("label.heroKpis.statsLoading.default"),
      color: "text-blue-600",
      bg: "bg-blue-50",
      href: "/network",
    },
    {
      icon: FolderOpen,
      label: t("label.heroKpis.activeprojects"),
      value: homeStats?.projects ?? 127,
      delta: homeStats ? `+${homeStats.newProjectsThisQuarter} + " " + ${t("label.heroKpis.homestats.quarter")}` : "+18 " + t("label.heroKpis.homestats.quarter"),
    ...
    {
      icon: Globe,
      label: t("label.heroKpis.partnerships"),
      value: homeStats?.partners ?? 892,
      delta: homeStats ? `+${homeStats.newPartnersThisMonth} + " " + ${t("label.heroKpis.homestats.month")}` : "+24 " + t("label.heroKpis.homestats.month"),
    ...
    {
      icon: Calendar,
      label: t("label.heroKpis.events"),
      value: homeStats?.events ?? 45,
      delta: homeStats ? `${homeStats.eventsThisYear} + " " + ${t("label.heroKpis.homestats.year")}` : t("label.heroKpis.homestats.year"),
