...
const quickActions: QuickAction[] = [
    {
        ...
        prompt: "Quelles sont les dernières statistiques des Projets en Afrique ?",
    },
    {
        icon: FileText,
    ...
    },
    {
        ...
        prompt: "Quels Projets sont actifs dans la région CEDEAO ?",
    },
    {
        icon: HelpCircle,
        label: "Aide UDC",
                    ...
                    >
                        ...
                        <div className="p-4 border-t border-border bg-card">
                            ...
                            <p className="text-[10px] text-muted-foreground text-center mt-2">
                                SUTA utilise l'IA pour vous assister. Vérifiez
